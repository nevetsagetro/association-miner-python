...
* **`requirements.txt`**: This file lists the Python dependencies required to run the project, including `pandas` for data handling, `matplotlib` and `seaborn` for generating graphs.
